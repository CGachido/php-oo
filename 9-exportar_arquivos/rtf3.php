...
$table->setBorderForCellRange(PHPRtfLite_Border::create($rtf, 1, '#000000'), 1, 1, $table->getRowsCount(), $table->getColumnsCount());
...
$rtf->save('tmp/rtf3.rtf');

echo "Arquivo gerado com sucesso.<br>";
echo "<a href='tmp/rtf3.rtf'>Clique aqui para visualizar</a>.";

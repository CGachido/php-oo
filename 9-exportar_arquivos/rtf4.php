...
$table->setBorderForCellRange(PHPRtfLite_Border::create($rtf, 0.7, '#000000'), 1, 1, $table->getRowsCount(), $table->getColumnsCount());

// envia o RTF ao usuário
$rtf->save('tmp/rtf4.rtf');

echo "Arquivo gerado com sucesso.<br>";
echo "<a href='tmp/rtf4.rtf'>Clique aqui para visualizar</a>.";
